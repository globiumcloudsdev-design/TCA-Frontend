...
//  */
// const transformVouchersList = async (response, classService = null, sectionService = null) => {
//   const vouchers = await Promise.all(
//     (response.data?.vouchers || response.data || []).map(v => transformVoucherResponse(v, classService, sectionService))
//   );
//   return {
//     vouchers,
...
//    */
//   getAll: async (filters = {}, pagination = {}, requestOptions = {}, classService = null, sectionServiceParam = null) => {
//     try {
...
//       // Use imported services with caching
//       return transformVouchersList(response.data, classService || classService, sectionServiceParam || sectionService);
//     } catch (error) {
