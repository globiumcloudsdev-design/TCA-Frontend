...
export const PERMISSIONS = {
  ...
  // Admissions
  ADMISSION_CREATE: 'admissions.create',
  ADMISSION_READ: 'admissions.read',
  ADMISSION_UPDATE: 'admissions.update',
  ADMISSION_DELETE: 'admissions.delete',
  ADMISSION_APPROVE: 'admissions.approve',
  ...
  // Attendance
  ATTENDANCE_CREATE: 'attendance.mark',
  ATTENDANCE_READ: 'attendance.view',
  ATTENDANCE_UPDATE: 'attendance.mark',
  ...
  FEE_COLLECT: 'fees.collect',
  FEE_REFUND: 'fees.refund',
  FEE_EXPORT: 'fees.export',

  // Fee Templates
  FEE_TEMPLATE_CREATE: 'fee_templates.create',
  FEE_TEMPLATE_READ: 'fee_templates.read',
  FEE_TEMPLATE_UPDATE: 'fee_templates.update',
  FEE_TEMPLATE_DELETE: 'fee_templates.delete',
  FEE_TEMPLATE_ASSIGN: 'fee_templates.assign',
  ...
  EXAM_PUBLISH: 'exam_results.publish',
  ...
  PAYROLL_GENERATE: 'payroll.process',
  PAYROLL_EXPORT: 'payroll.report',
  LEAVE_READ: 'leave_policies.read',
  LEAVE_CREATE: 'leave_policies.create',
  LEAVE_APPROVE: 'teachers.leave_approve',
  ...
  // School / Settings
  SCHOOL_UPDATE: 'settings.update',
  SCHOOL_SETTINGS: 'settings.view',
  SCHOOL_ASSIGN_ROLE: 'branches.assign_role',
