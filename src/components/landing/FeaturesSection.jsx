...
const FEATURES = [
  ...
  { icon: Globe, title: 'Multi-Branch Support', description: 'Manage multiple campuses from one centralized dashboard.', color: 'text-tca-primary/10', bg: 'group-hover:bg-tca-primary/10' },
  { icon: BarChart3, title: 'Advanced Analytics', description: 'Interactive charts for attendance, fees, and performance.', color: 'text-tca-primary', bg: 'group-hover:bg-tca-primary/10' },
  ...
  { icon: Smartphone, title: 'Mobile Responsive', description: 'Manage your school on the go with our fully responsive UI.', color: 'text-tca-primary', bg: 'group-hover:bg-tca-primary/10' },
  ...
  { icon: UserCheck, title: 'Role-Based Access', description: 'Customized views for Admins, Teachers, and Accountants.', color: 'text-tca-primary', bg: 'group-hover:bg-tca-primary/10' },
  { icon: FileText, title: 'Export Everything', description: 'Download reports as PDF, Excel, CSV, or JSON instantly.', color: 'text-tca-primary', bg: 'group-hover:bg-tca-primary/10' },
...
export default function FeaturesSection() {
  return (
    <section id="features" className="py-24 bg-tca-bg relative overflow-hidden">
      {/* Background Orbs */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-tca-primary/5 rounded-full blur-[120px]" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-tca-dark/5 rounded-full blur-[120px]" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Header Section */}
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-tca-primary/10 border border-tca-primary/10 text-tca-primary text-xs font-bold uppercase tracking-widest mb-6">
            <Sparkles className="w-3 h-3" />
            Cutting-Edge Capabilities
          </div>
          <h2 className="text-4xl md:text-5xl font-black text-white mb-6 tracking-tight leading-tight">
            Everything your school needs, <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-tca-primary via-tca-primary to-tca-primary">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {FEATURES.map((f, i) => {
            ...
            return (
              <div
                key={i}
                className="group relative p-8 rounded-[2rem] bg-slate-900/40 border border-white/5 hover:border-white/10 transition-all duration-500 hover:shadow-2xl hover:shadow-tca-primary/10 hover:-translate-y-1 overflow-hidden"
              >
                {/* Hover Glow Effect */}
                ...
                {/* Content */}
                <h3 className="text-lg font-bold text-white mb-3 group-hover:text-tca-primary transition-colors">
                  {f.title}
                </h3>
