...
//   return (
//     <section id="pricing" className="py-24 bg-gradient-to-b from-slate-950 to-tca-primary relative overflow-hidden">
//       {/* Background */}
...
//       <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-tca-primary/10 rounded-full blur-3xl" />

//       <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//         {/* Header */}
//         <div className="text-center mb-12">
//           <p className="text-sm font-semibold text-tca-primary uppercase tracking-widest mb-3">Pricing</p>
...
//               className={`relative w-12 h-6 rounded-full transition-colors ${yearly ? 'bg-tca-primary/10' : 'bg-slate-600'}`}
//             >
...
//                   plan.popular
//                     ? 'bg-white shadow-2xl shadow-tca-primary/50 lg:scale-105 ring-2 ring-tca-primary/10'
//                     : 'bg-slate-800/60 border border-white/10 hover:border-white/20'
//                 }`}
//               >
//                 {plan.popular && (
//                   <div className="bg-gradient-to-r from-tca-dark to-tca-primary text-center py-2">
...
//                         plan.popular
//                           ? 'bg-gradient-to-r from-tca-dark to-tca-primary text-white hover:opacity-90'
//                           : plan.id === 'enterprise'
...
//                         {f.included ? (
//                           <CheckCircle className={`w-4 h-4 flex-shrink-0 ${plan.popular ? 'text-tca-primary/10' : 'text-emerald-500'}`} />
//                         ) : (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {PLANS.map((plan) => (
            ...
            >
              ...
              <div className="mb-8">
                <div className={`w-12 h-12 rounded-2xl flex items-center justify-center mb-6 ${plan.popular ? 'bg-tca-primary text-white' : 'bg-slate-800 text-slate-400'}`}>
              ...
              <div className="space-y-4 mb-10 flex-1">
                {plan.features.map((f, i) => (
                  <div key={i} className="flex items-start gap-3">
                    {f.included ? (
                      <CheckCircle className={`w-5 h-5 mt-0.5 ${plan.popular ? 'text-tca-primary/10' : 'text-emerald-500'}`} />
                    ) : (
        ...
        <div className="mt-16 text-center">
          <p className="text-slate-500 text-sm flex items-center justify-center gap-2">
            ...
            Need a custom plan for 5+ branches? <Link href="/contact" className="text-tca-primary hover:underline font-bold">Talk to our experts</Link>
          </p>
        </div>
      </div>
    </section>
